...
<head>
  ...
  <link rel="stylesheet" href="https://use.typekit.net/yav2qnd.css">
  <title>Daniel Boyden</title>
</head>

<body class="container">

  <header>
    <img src="images/logo_2.svg" alt="logo" class="logo">
    <nav>
      <ul>
        <li><a href="#">Home</a></li>
...
<section class="home-hero">
  ...
  <h2 class="title">3D Motion Graphics and UI/UX Designer</h2>
  <a href="#anchor2" class="button button-home button-accent">CHECK OUT MY WORK</a>

  <div class="click-me">
  <a href="#" class="click-me button button-home button-accent">VIDEO REEL</a>

  </div>

  <div class="light-box">
    <p class="exit">X</p>
    <video id="myVideo" src="includes/portfolio_video.mp4" controls>
...
<section class="home-about">
  ...
  <div class="home-about-textbox">
    <h1 id="anchor1" class="about-h1">ABOUT ME</h1>

    <svg class="about-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 643.78 416.29">
      <defs>
        <style>
      ...
      <g id="1fea0252-ffde-4760-86e4-2bcdc090e766" data-name="Layer 2">
        <g id="d868bad5-bf83-4952-beac-8378d930d3b9" data-name="about_me">
          <g id="016e4ea4-32f9-4ecd-9a98-79c2fe36a968" data-name="logo">
            ...
            <g id="4e592f1f-2fe2-4d8d-b171-3d933c33b62d" data-name="green" class="green">
            ...
            <g id="7778e753-d46a-4a2f-985f-de6cb31688cb" data-name="purple" class="purple">
            ...
            <g id="04c43b17-c2ed-4be0-a7a6-3fc6b7ef74ef" data-name="orange" class="orange">
    ...
    <p class="orange_info"><br>My name is Daniel Boyden</br><br>I am a second year student at fanshawe college</br><br>My program is Interactive Media Design and Production</br><br>I love being creative and unique with all my designs</br></p>
    <p class="green_info hidden"><br>Outside of school i create music with my friend</br><br>Finding new and unique sounds keeps me going</br><br>You can see what i have created here:</br><br><a href="https://soundcloud.com/user-453296407">https://soundcloud.com/user-453296407</a></p>
    <p class="purple_info hidden"><br>I would love to see where 3D Design takes me</br><br>Continue designing and creating new and organic stuff!</br><br>Push myself to learn new techniques and more efficient workflow.
     </br></p>
...
<div id="output">
  ...
  <h1 id="anchor3">Contact Me</h1>
  <main class="contact">

  <form class="contact-form" action="includes/contactform.php" method="post">
      <input type="text" name="name" value="" placeholder="Full Name" class="control">
      <input type="text" name="mail" value="" placeholder="Your Email" class="control">
      <input type="text" name="subject" value="" placeholder="Subject" class="control">
      <textarea name="message" rows="10" cols="50" placeholder="Message" class="textarea"></textarea>
      <button type="submit" name="submit" class="button button-accent control">SEND</button>
  </form>
...
<footer>
  <div class="span-3">
    <p>This website was designed and developed by me using various techniques i have learned over the course of two years. Thank you for checking it out. You can contact me in the section above if you have any questions or follow me on my social media linked below.  </p>
  </div>
  <div class="social-media">

<a href="https://www.facebook.com/"> <img   src="images/001-facebook.svg" alt="facebook"></a>
<a href="https://www.instagram.com/?hl=ensrc="> <img  src="images/002-instagram.svg" alt="instagram"></a>
<a  href="https://twitter.com/?lang=en"><img src="images/003-twitter.svg" alt="twitter"></a>
  </div>
  <div class="span-1">
    <ul class="unstyled-list">
     ...
     <li><a href="https://www.facebook.com/">Facebook</a></li>
      ...
      <li><a  href="https://www.instagram.com/?hl=ensrc=">Instagram</a></li>
    </ul>
  </div>

  <div class="span-2">
    <ul class="unstyled-list">
      <li><strong>Contact For</strong></li>
     <li>Brand Document</li>
      <li>Video Source</li>
      <li>Style Guide</li>
    </ul>
  </div>
